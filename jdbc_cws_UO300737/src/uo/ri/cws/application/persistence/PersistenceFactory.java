...
//     
     ...
     * 
     * public SupplyGateway forSupplyGateway() { return new SupplyGatewayImpl();
     * }
     * 
     * public SubstitutionGateway forSubstitutionsGateway() { return new
     * SubstitutionGatewayImpl(); }
     * 
     * public VehicleGateway forVehicle() { return new VehicleGatewayImpl(); }
     */
...
//     public ContractTypeGateway forContractType() { return new
//    		 ContractTypeGatewayImpl(); }
